...
namespace Exersise12_36
{
    class Program
    {
        static void InsertionSort(ref int[] array)
        {
            ...
            Console.WriteLine("Сортировка подстчетом завершена с количестом сравненений элементов равным " + compares + " и с кол-вом перестановок равным " + swaps);
        }
        ...
        static void CountingSort(ref int[] array)
        {
            ...
            Console.WriteLine("Сортировка подстчетом завершена с нулевым количестом сравненений элементов и с кол-вом перестановок равным " + array.Length);
        }
